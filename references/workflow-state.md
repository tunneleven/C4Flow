...
| 5 | CODE | 3: Implementation | Subagent-driven implementation with two-stage review |
...
| CODE | skills/code/SKILL.md | Main coordinator dispatching implementer subagents |
